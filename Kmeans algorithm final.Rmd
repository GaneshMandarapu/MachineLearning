...
Here we perform the last and the fourth step i mentioned above in introduction which we have to repeate the two steps assigning the closest centroids and calculating the centroids of new clusters. This process should be repeated untill the centroid no longer move it's position.
